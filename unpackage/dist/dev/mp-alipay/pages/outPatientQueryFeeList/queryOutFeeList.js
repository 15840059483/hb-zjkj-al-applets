...
/***/ 214:
/*!**************************************************************************************************************************************!*\
  !*** /Users/fanyouyi/Downloads/智慧医院支付宝小程序/hb/hb-zjkj-al-applets/main.js?{"page":"pages%2FoutPatientQueryFeeList%2FqueryOutFeeList"} ***!
  \**************************************************************************************************************************************/
...
var _queryOutFeeList = _interopRequireDefault(__webpack_require__(/*! ./pages/outPatientQueryFeeList/queryOutFeeList.vue */ 215));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/***/ 215:
/*!*******************************************************************************************************************!*\
  !*** /Users/fanyouyi/Downloads/智慧医院支付宝小程序/hb/hb-zjkj-al-applets/pages/outPatientQueryFeeList/queryOutFeeList.vue ***!
  \*******************************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _queryOutFeeList_vue_vue_type_template_id_1a39b47b_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./queryOutFeeList.vue?vue&type=template&id=1a39b47b&scoped=true& */ 216);
/* harmony import */ var _queryOutFeeList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./queryOutFeeList.vue?vue&type=script&lang=js& */ 218);
...
/* harmony import */ var _queryOutFeeList_vue_vue_type_style_index_0_id_1a39b47b_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./queryOutFeeList.vue?vue&type=style&index=0&id=1a39b47b&scoped=true&lang=css& */ 221);
...
/***/ 216:
/*!**************************************************************************************************************************************************************!*\
  !*** /Users/fanyouyi/Downloads/智慧医院支付宝小程序/hb/hb-zjkj-al-applets/pages/outPatientQueryFeeList/queryOutFeeList.vue?vue&type=template&id=1a39b47b&scoped=true& ***!
  \**************************************************************************************************************************************************************/
...
try {
  components = {
    ...
    uniRow: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-row/components/uni-row/uni-row */ "uni_modules/uni-row/components/uni-row/uni-row").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-row/components/uni-row/uni-row.vue */ 459))
    }
  }
} catch (e) {
  if (
...
/***/ 218:
/*!********************************************************************************************************************************************!*\
  !*** /Users/fanyouyi/Downloads/智慧医院支付宝小程序/hb/hb-zjkj-al-applets/pages/outPatientQueryFeeList/queryOutFeeList.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__(/*! ./queryOutFeeList.scss */ 220); //
//
//
//
//
...
var _default = { // 调用头部组件
  ...
  computed: { processingName: function processingName() {return function (str) {if (!str) {return '-';}if (null != str && str != undefined) {var star = ''; //存放名字中间的*
      ...
      isSelectAll: false, paymentList: [], switchPatientList: [], currentPatient: {}, selectPaymentList: [], selectPaymentMoOrderList: [], totalMoney: 0, token: '' };}, methods: { // 就诊人中的全部方法
    //触发切换就诊人的弹窗
    switchPatient: function switchPatient() {this.showSwitchPatient = true;}, addUser: function addUser() {uni.navigateTo({ url: '/pages/empower/empower' });}, //就诊人信息的数据
    //就诊人信息的数据
    getPatientInfo: function getPatientInfo() {var _this2 = this;var token = my.getStorageSync({ key: 'token' }).data;if (!token) {uni.navigateTo({ url: '/pages/empower/empower' });return;}var _this = this;this.$myRequest({ url: "/wechat/user/patientcard/info" }).then(function (data) {if (data.data.length > 0 && data.data[0].cardNumber) {_this2.switchPatientList = data.data;_this2.currentPatient = data.data[0];_this.getOutPayList();}console.log(data.data.length > 0 && !data.data[0].cardNumber, "判断用户信息");if (data.data.length > 0 && !data.data[0].cardNumber) {uni.showModal({ title: "提示", content: "是否添加就诊卡号?", success: function success(res) {if (res.confirm) {_this.addCard(data);} else {uni.showToast({ title: '已取消添加就诊卡号！', icon: 'none', duration: 2000 });}} });}if (!data.data.length > 0) {_this2.loading = false;uni.showModal({ title: "提示", content: "是否添加就诊人?", success: function success(res) {if (res.confirm) {uni.navigateTo({ url: '/pages/patient-management/add-patient/add-patient' });} else {uni.showToast({ title: '已取消添加就诊人！', icon: 'none', duration: 2000 });}} });}_this2.loading = false;}).catch(function (err) {_this2.loading = false;});}, addCard: function addCard(data) {var _this3 = this;var params = Object.assign(data.data[0], { cardNo: '' });console.log("开始了呀");this.$myRequest({ url: "/wechat/user/addPtCard/info", contentType: 'application/json;charset=UTF-8', data: params }).then(function (data) {console.log("完成");_this3.loading = false;_this3.getPatientInfo();}).catch(function (err) {_this3.loading = false;});}, //切换就诊人，这个参数中包含就诊人信息
    ...
    getOutPayList: function getOutPayList() {var _this4 = this;var params = { patientNo: this.currentPatient.cardNumber };this.$myRequest({ url: "/hospt/getOutBillList", data: params }).then(function (data) {_this4.paymentList = data.data;if (_this4.paymentList) {_this4.paymentList.forEach(function (item) {item.isOpen = true;item.totalMoney = 0;});}_this4.loading = false;}).catch(function (err) {_this4.loading = false;});this.paymentList.forEach(function (item) {// item.isOpen = true;
        // this.openList(item);
        item.totalMoney = 0;});}, openList: function openList(item) {this.$forceUpdate();this.$set(item, "isOpen", !item.isOpen);}, isChecked: function isChecked(item) {var selectNum = 0;this.selectPaymentList.forEach(function (pay) {if (pay.regNo === item.regInfos.regNo) {selectNum++;}});return selectNum === item.outFeeList.length;}, paymentCheck: function paymentCheck(item) {var _this5 = this;if (this.selectPaymentList.length && this.selectPaymentList[0].regNo != item.regInfos.regNo) {this.selectPaymentList = [];this.selectPaymentMoOrderList = [];}if (this.isChecked(item)) {for (var i = this.selectPaymentList.length - 1; i >= 0; i--) {if (this.selectPaymentList[i].regNo === item.regInfos.regNo) {this.selectPaymentList.splice(i, 1);this.selectPaymentMoOrderList.splice(i, 1);}}} else {item.outFeeList.forEach(function (outFee) {var recipe = _this5.selectPaymentList.map(function (list) {return list.recipeNo;});if (recipe.indexOf(outFee.recipeNo) === -1) {outFee.regNo = item.regInfos.regNo;_this5.selectPaymentList.push(outFee);_this5.selectPaymentMoOrderList.push(outFee.recipeNo);}});}this.calculationTotalMoney(item); // this.judgeWhetherSelectAll();
    }, // 选择处方
    ...
    onSelectAllBtn: function onSelectAllBtn() {var _this6 = this;this.selectPaymentList = [];this.selectPaymentMoOrderList = [];if (this.isSelectAll) {this.paymentList.forEach(function (item) {item.outFeeList.forEach(function (outFee) {outFee.regNo = item.regInfos.regNo;_this6.selectPaymentList.push(outFee);_this6.selectPaymentMoOrderList.push(outFee.recipeNo);});});}this.calculationTotalMoney();}, // 是否全选
...
/***/ 221:
/*!****************************************************************************************************************************************************************************!*\
  !*** /Users/fanyouyi/Downloads/智慧医院支付宝小程序/hb/hb-zjkj-al-applets/pages/outPatientQueryFeeList/queryOutFeeList.vue?vue&type=style&index=0&id=1a39b47b&scoped=true&lang=css& ***!
  \****************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
